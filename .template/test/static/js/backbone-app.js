(function(){
	OG.Model = Backbone.Model.extend({
        urlRoot : '/data',
        defaults: {
            id: null,
            name: ''
    ...
    OG.Collection = Backbone.Collection.extend({
        model: OG.Model,
        url: '/data',
        ...
        load: function(url, callback) {
            ...
            jQuery.ajax({ //load template
                ...
                complete: function(resp) {
                    var cache =
                        this.cache[url] = resp.responseText; // cache it _.template();
    ...
    OG.View = Backbone.View.extend({
        el: null,
        renderQueue: false,
		template: null,
        initialize: function() {
            if (this.templateUrl) {
                OG.Template.load(this.templateUrl, function(data) {
					 //console.log(data);
                    this.template = data;
